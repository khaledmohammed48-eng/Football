...
export default function CoachLeagueDetailPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto" dir="rtl">
      <div className="mb-6">
        <Link href="/coach/leagues" className="text-sm text-gray-400 hover:text-gray-600 mb-1 inline-block">← الدوريات</Link>
      ...
      {tab === 'matches' && (
        <div className="space-y-4">
          {league.matches.length === 0 ? (
            <div className="text-center py-10 text-gray-400 bg-white rounded-2xl border border-gray-100">لم يتم توليد المباريات بعد</div>
          ) : rounds.map(round => (
